...
import { SourceFileMap, ObjectData, AttributeData, PropertyData, GlobalData, ConstantData, RoutineData, StringData, TableData, DictWordData, PrepositionData, GrammarVerbData, GrammarLineData, ActionData, CommentaryMap, CommentaryLineMap, AllDistanceMap, MapRoom, SourceLinesMap } from './gametypes';
...
export const gamedat_objproptable_addrs = winany.gamedat_objproptable_addrs as Map<number, TableData>;
