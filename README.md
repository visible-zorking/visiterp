...
- zork1-i6.inf: A translation of the disassembled game code into Inform 6 source, done by [Allen Garvin][zi6]. We're not going to use this directly, but (if you know I6) it's very helpful in understanding the ZIL behavior.
- zork1.reform: A text file mapping game object numbers, routine addresses, and other numeric values to human-readable names. This is taken from the [analysis work][reform] done in 2007 by Allen Garvin, Ben Rudiak-Gould, and Ethan Dicks.
...
[zi6]: http://plover.net/~agarvin/zork1.txt
